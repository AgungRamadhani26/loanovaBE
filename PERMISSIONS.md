...
| Permission              | Description                                                  | Controller Method                    | Assigned Roles                              |
| :---------------------- | :----------------------------------------------------------- | :----------------------------------- | :------------------------------------------ |
| `DASHBOARD:STATISTICS`  | Melihat statistik dashboard (role-based filtered data).      | `DashboardController.getStatistics`  | SUPERADMIN, MARKETING, BRANCHMANAGER, BACKOFFICE |
...
| :---------------- | :---------------: | :------------------------------------------------------------------------ |
| **SUPERADMIN**    | 35                | Full administrative control + All menu visibility + Dashboard statistics. |
| **MARKETING**     | 12                | Branch data + Loan review stage + Dashboard/Loan/History menus + Dashboard statistics. |
| **BRANCHMANAGER** | 12                | Branch data + Loan approval stage + Dashboard/Loan/History menus + Dashboard statistics. |
| **BACKOFFICE**    | 18                | User data (read) + Plafond data (read) + Loan disbursement + User Plafond + Dashboard/Loan/UserPlafond menus + Dashboard statistics. |
