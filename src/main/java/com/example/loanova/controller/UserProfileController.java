...
public class UserProfileController {
    ...
    /**
     * LENGKAPI PROFIL
     * Khusus role CUSTOMER. Menggunakan multipart/form-data untuk unggahn file.
     */
    ...
    public ResponseEntity<ApiResponse<UserProfileResponse>> completeProfile(
        ...
        UserProfileResponse response = userProfileService.completeProfile(authentication.getName(), request);
    ...
    public ResponseEntity<ApiResponse<UserProfileResponse>> updateProfile(
            ...
            Authentication authentication) {
        UserProfileResponse response = userProfileService.updateProfile(authentication.getName(), request);
