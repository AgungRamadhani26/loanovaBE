...
/**
 * USER PLAFOND ENTITY Merepresentasikan mapping antara User (CUSTOMER) dengan Plafond yang
 * diberikan. Entity ini menyimpan informasi plafond yang diberikan kepada customer.
 *
 * <p>Relasi: - User (One) -> UserPlafond (Many): Satu user bisa memiliki banyak plafond - Plafond
