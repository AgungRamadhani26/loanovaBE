...
/**
 * LOAN APPLICATION ENTITY Merepresentasikan pengajuan pinjaman dari customer. Entity ini menyimpan
 * data aplikasi pinjaman beserta snapshot data customer pada saat pengajuan untuk keperluan audit
 * dan tracking perubahan data.
 *
 * <p>Relasi: - Branch (One) -> LoanApplication (Many): Satu branch mengelola banyak aplikasi - User
 * (One) -> LoanApplication (Many): Satu user (customer) bisa mengajukan banyak pinjaman - Plafond
 * (One) -> LoanApplication (Many): Satu paket plafond bisa digunakan untuk banyak aplikasi -
 * LoanApplication (One) -> ApplicationHistory (Many): Satu aplikasi punya banyak history status
 */
@Entity
