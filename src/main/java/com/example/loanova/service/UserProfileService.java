...
public class UserProfileService {
    ...
    public UserProfileResponse completeProfile(String username, UserProfileCompleteRequest request) {
        ...
        if (userProfileRepository.findByUser(user).isPresent()) {
            throw new BusinessException("Profil sudah dilengkapi. Gunakan fitur update untuk mengubah data.");
        }
    ...
    public UserProfileResponse updateProfile(String username, UserProfileUpdateRequest request) {
        ...
        validateUniqueness(request.getNik(), request.getPhoneNumber(), request.getNpwpNumber(), userProfile.getId());
     ...
     */
    private void validateUniqueness(String nik, String phoneNumber, String npwpNumber, Long currentProfileId) {
        // Check NIK
